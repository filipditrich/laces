	...
	<div id="registration-form">
		...
		<div class="reg-container">
			...
			<form action="#" class="form-register">
				<ul class="form-register-list">
					<li>
						<input type="text" name="name1" placeholder="First Name">
						<label for="name1">First Name</label>
						<span>An error occured while proceeding.</span>
					...
					<li>
						...
						<span>An error occured while proceeding.</span>
						<input type="text" name="username" placeholder="Your User ID">
				...
				<footer>
					<button type="reset" class="form-button-clear">Reset All</button>
					<button type="submit" class="form-button-register">Register</button>
				</footer>
			</form>
		</div>
	</div>
